...
namespace NatePage\Standards\Sniffs\Commenting;
...
class DocCommentSpacingSniff implements Sniff
{
     ...
     * @return void
     */
    private function checkDifferentAnnotations(Annotation $annotation, int $linesCount): void
    {
        if ($linesCount === 1) {
            return;
        }
     ...
     * @throws \SlevomatCodingStandard\Helpers\EmptyFileException
     */
    private function checkLinesAfterLastContent(int $closePointer, int $lastPointer): void
    {
     ...
     * @throws \SlevomatCodingStandard\Helpers\EmptyFileException
     */
    private function checkLinesBetweenAnnotationsTypes(array $annotations): void
    {
     ...
     * @return void
     */
    private function checkSameAnnotations(Annotation $annotation, int $linesCount): void
    {
        if ($linesCount === 0) {
            return;
        }
     ...
     * @throws \SlevomatCodingStandard\Helpers\EmptyFileException
     */
    private function countLinesBetweenAnnotations(Annotation $current, Annotation $previous): int
    {
        $tokens = $this->tokens;
     ...
     * @return int
     */
    private function getFirstContentEndPointer(int $firstPointer, int $openPointer): int
    {
